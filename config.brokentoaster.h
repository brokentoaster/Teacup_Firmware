...
/** \file
	\brief NAL Reprap Mendle Gen 3 Configuration
*/
/*
	CONTENTS
...
#define	STEPS_PER_M_Z				640000

/// http://blog.arcol.hu/?p=157 may help with this one
//#define	STEPS_PER_MM_E				2.210

// this version is for SF_40
#define	STEPS_PER_M_E				96000
...
#define	MAXIMUM_FEEDRATE_X		10000UL
#define	MAXIMUM_FEEDRATE_Y		10000UL
#define	MAXIMUM_FEEDRATE_Z		100UL
#define	MAXIMUM_FEEDRATE_E		1000UL
...
/** \def REPRAP_HOST_COMPATIBILITYDIO18
	RepRap Host changes it's communications protocol from time to time and
	intentionally avoids backwards compatibility. Set this to the date the
	source code of your Host was fetched from RepRap's repository, which is
	likely also the build date.
	See the discussion on the reprap-dev mailing list from 11 Oct. 2010.

	Undefine it for best human readability, set it to an old date for
	compatibility with hosts before August 2010
*/
...
/**
	Baud rate for the connection to the host. Usually 115200, other common
	values are 19200, 38400 or 57600.
*/
#define	BAUD	115200

/** \def XONXOFF
	Xon/Xoff flow control.
		Redundant when using RepRap Host for sending GCode, but mandatory
		when sending GCode files with a plain terminal emulator, like
		GtkTerm (Linux), CoolTerm (Mac) or HyperTerminal (Windows).
...
/** \def DEBUGDIO18
	DEBUG
		enables /heaps/ of extra64 output, and some extra M-codes.
...
/**
	move buffer size, in number of moves
		note that each move takes a fair chunk of ram (69 bytes as of
		this writing) so don't make the buffer too big - a bigger serial
		readbuffer may help more than increasing this unless your gcodes
		are more than 70 characters long on average.
		however, a larger movebuffer will probably help with lots of
